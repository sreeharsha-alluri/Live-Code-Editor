...
<body>
    ...
    <div class="main-content">
        ...
        <form class="form-register" autocomplete = "off" method="post" onsubmit="return validate();">
		...
		<br>		
                <a href="index.jsp" class="form-log-in-with-existing">One of us? <b> Login here </b></a>
